...
<div class="hero text-center text-white d-flex align-items-center">
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between mb-3 align-items-center">
            ...
            <a href="<?php echo e(route('products')); ?>" class="btn btn-primary me-2">Lihat Semua Produk</a>
        </div>
        <div class="row" id="container-barang">

            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(asset('assets/NIKE_P_6000.jpg')); ?>" class="card-img-top" alt="Sepatu" />
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(asset('assets/AIR_FORCE_1.jpg')); ?>" class="card-img-top" alt="Sepatu" />
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(asset('assets/AIR_JORDAN_1_LOW.jpg')); ?>" class="card-img-top" alt="Sepatu" />
                    <div class="card-body">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\laragon\www\Praktikum_SIWEB_WEEK8\resources\views/index.blade.php ENDPATH**/ ?>